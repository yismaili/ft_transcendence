...
export default function Section3() {
  ...
  const phoneSwap = (side: string) => {
    if (side == "left") {
      if (pos.firstTitlePos == "left")
        swapTitles("first");
      else if (pos.secondTitlePos == "left")
        swapTitles("second");
      else
        swapTitles("third");
    }else if (side == "right") { 
      if (pos.firstTitlePos == "right")
        swapTitles("first");
      else if (pos.secondTitlePos == "right")
        swapTitles("second");
      else
  ...
  return (
    <section className={Style.container} id="section4">
      ...
      <div className={Style.switch}>
        <span className={Style.leftArrow} onClick={() =>phoneSwap("left") }></span>
        <span className={Style.rightArrow} onClick={() =>phoneSwap("right")}></span>
      </div>
    </section>
  );
}
