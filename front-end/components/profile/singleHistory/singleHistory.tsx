...
export default function SingleHistory(prop: hys) {
  ...
  return (
    <div className="singleHistory__container" style={{backgroundColor:`${(prop.Player1Score > prop.Player2Score)? "green":"red"}`}}>
      <div className="singleHistory__userImg__username">
        ...
        ></span>
        <span>{prop.Player1.uniquename}</span>
      </div>
      ...
      <div className="singleHistory__userImg__username">
        <span>{prop.Player2.uniquename}</span>
        <span
        className="singleHistory__userImg"
          style={{
